...
Replaces the hand-tuned OR-rule in ``component_analysis`` with a
HistGradientBoosting model trained on per-component shape features with weak
(folder-level) labels. Image-level GroupKFold CV on the 100-frame dark+green
ch1 benchmark: 73% frame accuracy vs 43% for the rule (see
``docs/notes/2026-07-04-component-grade-model.md``).
