...
Synthetic tests pin the pipeline behaviour (dependency-light). The full
82-image reproduction (AUC 0.809, accuracy 87.8%) is documented in
docs/notes/2026-07-04-heuristic-talcose-classifier.md and validated against
outputs/talc_annotation_v1/ when that data is present.
"""
